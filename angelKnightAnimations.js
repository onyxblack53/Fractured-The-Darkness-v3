...
// Every character state renders from painted pose-sheet artwork.

export const POSE_SHEET="./assets/angel_knight_pose_sheet.png?v=8.1";
...
export const CLIPS={
  ...
  run:{loop:true,frames:[
    f("run",82,{y:0,scale:1,rot:-.015}),
    f("run",82,{y:-7,scale:1.01,rot:.008}),
    f("run",82,{y:-2,scale:1,rot:-.008})
  ]},

  crouch:{loop:true,frames:[f("jumpAntic",180,{y:6,scale:.98})]},
  ...
  land:{loop:false,frames:[
    ...
    f("idle",120,{y:0,scale:1})
  ]},

  attack1:{loop:false,lock:true,frames:[
  ...
  attack2:{loop:false,lock:true,frames:[
  ...
  attack3:{loop:false,lock:true,frames:[
  ...
  blockHit:{loop:false,lock:true,frames:[
    f("block",70,{x:-8,rot:-.025}),
    f("block",95,{x:2,rot:.010}),
    f("block",90)
  ]},

  dodge:{loop:false,lock:true,frames:[
  ...
  heal:{loop:false,lock:true,frames:[
    f("heal",180,{y:-2,scale:1}),
    f("heal",220,{y:-4,scale:1.015,event:"heal"}),
    f("heal",180,{y:-1,scale:1.005}),
    f("idle",80)
  ]},

  hit:{loop:false,lock:true,frames:[
    f("hit",100,{x:-8,rot:-.045}),
    f("hit",120,{x:-3,rot:-.020}),
    f("idle",100)
  ]},

  death:{loop:false,lock:true,frames:[
